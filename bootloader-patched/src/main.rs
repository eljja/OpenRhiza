...
fn bootloader_main(
    ...
    use core::fmt::Write;
    write!(printer::Printer, "Bootloader main started...").unwrap();
    ...
    write!(printer::Printer, "Bootloader Phase 1...").unwrap();
    ...
    write!(printer::Printer, " Phase 2...").unwrap();
    ...
    write!(printer::Printer, " Phase 3...").unwrap();
    ...
    write!(printer::Printer, " JUMPING TO KERNEL!").unwrap();
