...
set_up_page_tables:
    ...
    jb map_p2_table
    # p1
    # start mapping from page 1 (0x1000) to ensure we map the stack,
    # bootloader code, and the relocated page tables up to __page_table_end.
    mov eax, 0x1000
    or eax, (1 | 2)
    mov ecx, 1
    mov edx, offset __page_table_end
