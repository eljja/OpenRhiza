...
static INIT_MSG: &[u8] = b"[Skill] registry_lookup bootstrap initialized.\n";
static RUN_MSG: &[u8] =
    b"[Skill] registry_lookup bootstrap: query local cache first, then OpenRhiza registry, then generate.\n";
